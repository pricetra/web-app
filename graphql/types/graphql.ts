...
export type ProductSummaryQuery = { __typename?: 'Query', productSummary: { __typename?: 'ProductSummary', id: number, name: string, image: string, description: string, brand: string, code: string } };
