...
export type GetAllProductListsByListIdQuery = { __typename?: 'Query', getAllProductListsByListId: Array<{ __typename?: 'ProductList', id: number, listId: number, userId: number, productId: number, type?: ListType | null, stockId?: number | null, createdAt: any, product?: { __typename?: 'Product', id: number, name: string, image: string, description: string, brand: string, code: string, model?: string | null, categoryId: number, approximateWeight: boolean, netWeight: boolean, weightValue?: number | null, weightType?: string | null, quantityValue: number, quantityType: string, createdAt: any, updatedAt: any, category?: { __typename?: 'Category', id: number, name: string, expandedPathname: string, path: string } | null } | null, stock?: { __typename?: 'Stock', id: number, productId: number, storeId: number, branchId: number, latestPriceId: number, store?: { __typename?: 'Store', id: number, name: string, logo: string } | null, branch?: { __typename?: 'BranchFlat', id: number, name: string, address: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string } } | null, latestPrice?: { __typename?: 'Price', id: number, productId: number, branchId: number, storeId: number, amount: number, currencyCode: string, createdAt: any, sale: boolean, originalPrice?: number | null, condition?: string | null, expiresAt?: any | null, unitType: string } | null } | null }> };
