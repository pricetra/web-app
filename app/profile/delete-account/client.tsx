    ...
    <div>
      ...
      <div className="flex flex-col gap-7 justify-between">
        <div>
          ...
          <h5 className="font-bold font-lg mt-2">
            This action will delete <i>your</i>
          </h5>
          <ul className="list-disc list-inside">
            ...
            <li>
              Any relations to any product, store, branch, or price
              creation/management
            </li>
            <li>
              <i>
                Your account will no longer be accessible or recoverable after
                deletion
              </i>
            </li>
          </ul>
        ...
        <div>
          ...
          >
            <b>Confirm and Delete My Account</b>
          </Button>
        </div>
      </div>
    </div>
